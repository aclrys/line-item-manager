...
This is the preferred method to install line-item-manager, as it will always install the most recent stable release.
...
The sources for line-item-manager can be downloaded from the `Github repo`_.
